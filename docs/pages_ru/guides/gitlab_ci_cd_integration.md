...
Окончательные версии .gitlab-ci.yml для различных workflow доступны [в конце статьи](#полный-gitlab-ciyml-для-различных-стратегий). 

> С общей информацией по организации CI/CD с помощью werf можно ознакомиться в [отдельной статье](https://docs.google.com/document/d/1g18s9GoNZpUOns71NwA4FnjM-njhNHmS4t5bumrlBaI/edit#heading=h.p4fw6g37qtye)
...
> Данный вариант реализует подход описанный в разделе [Выкат на review из pull request по кнопке](https://docs.google.com/document/d/1g18s9GoNZpUOns71NwA4FnjM-njhNHmS4t5bumrlBaI/edit#heading=h.xib2ms9j1o99) 
...
> Данный вариант реализует подход описанный в разделе [Выкат на review из ветки по шаблону автоматически](https://docs.google.com/document/d/1g18s9GoNZpUOns71NwA4FnjM-njhNHmS4t5bumrlBaI/edit#heading=h.ryrb99x4bq23)
...
> Данный вариант реализует подход описанный в разделе [Выкат на review из pull request автоматически после ручной активации](https://docs.google.com/document/d/1g18s9GoNZpUOns71NwA4FnjM-njhNHmS4t5bumrlBaI/edit#heading=h.7oy3r0fwbcx)
...
В нашем случае, данные окружения являются определяющими, поэтому названия вариантов соответствуют названиям окончательных workflow, предложенных в [конце статьи](#полный-gitlab-ciyml-для-различных-стратегий). 

##### №1 Fast and Furious (рекомендованный)

> Данный вариант реализует подходы описанные в разделах [Выкат на production из master автоматически](https://docs.google.com/document/d/1g18s9GoNZpUOns71NwA4FnjM-njhNHmS4t5bumrlBaI/edit#heading=h.mh294ds69wjc) и [Выкат на production-like из pull request по кнопке](https://docs.google.com/document/d/1g18s9GoNZpUOns71NwA4FnjM-njhNHmS4t5bumrlBaI/edit#heading=h.9pevzcj5t4zq)
...
> Данный вариант реализует подходы описанные в разделах [Выкат на production из master по кнопке](https://docs.google.com/document/d/1g18s9GoNZpUOns71NwA4FnjM-njhNHmS4t5bumrlBaI/edit#heading=h.tcj5eynl53qo) и [Выкат на staging из master автоматически](https://docs.google.com/document/d/1g18s9GoNZpUOns71NwA4FnjM-njhNHmS4t5bumrlBaI/edit#heading=h.q5f77t9m8pds)
...
> Данный вариант реализует подходы описанные в разделах [Выкат на production из тега автоматически](https://docs.google.com/document/d/1g18s9GoNZpUOns71NwA4FnjM-njhNHmS4t5bumrlBaI/edit#heading=h.7b7nt72tg0pe) и [Выкат на staging из master по кнопке](https://docs.google.com/document/d/1g18s9GoNZpUOns71NwA4FnjM-njhNHmS4t5bumrlBaI/edit#heading=h.1gs5ewz3mwr0)
...
> Данный вариант реализует подходы описанные в разделах [Выкат на production из ветки автоматически](https://docs.google.com/document/d/1g18s9GoNZpUOns71NwA4FnjM-njhNHmS4t5bumrlBaI/edit#heading=h.sih1symegefh) и [Выкат на production-like из ветки автоматически](https://docs.google.com/document/d/1g18s9GoNZpUOns71NwA4FnjM-njhNHmS4t5bumrlBaI/edit#heading=h.kgxn3eqb78dd)
...
> Подробнее про workflow можно почитать в отдельной [статье](https://docs.google.com/document/d/1g18s9GoNZpUOns71NwA4FnjM-njhNHmS4t5bumrlBaI/edit#heading=h.ocazsqabmj90)
...
> Подробнее про workflow можно почитать в отдельной [статье](https://docs.google.com/document/d/1g18s9GoNZpUOns71NwA4FnjM-njhNHmS4t5bumrlBaI/edit#heading=h.kajl7vfo975m)
...
> Подробнее про workflow можно почитать в отдельной [статье](https://docs.google.com/document/d/1g18s9GoNZpUOns71NwA4FnjM-njhNHmS4t5bumrlBaI/edit#heading=h.yclxnnid23il)
...
> Подробнее про workflow можно почитать в отдельной [статье](https://docs.google.com/document/d/1g18s9GoNZpUOns71NwA4FnjM-njhNHmS4t5bumrlBaI/edit#heading=h.5eg7anoaljgl)
